                                                       ...
                                                       <form id="designfrm"  method="POST" class="form-horizontal" data-bitwarden-watching="1">
                                                            <div class="row">
                                                                 ...
                                                                 <div class="row mt-2 mx-2 buttonNoti d-none align-items-center">
                                                                      ...
                                                                      <div class="col">
                                                                           <h4 class="card-title mt-2 mb-0" style="font-weight: 800;">
                                                                                Configuración Botón
                                                                           </h4>
                                                                      </div>
                                                                      <div class="col-auto">
                                                                           <button type="button"
                                                                                     id="btnAddNotiSection"
                                                                                ...
                                                                                <div class="modal_design">
                                                                                     <div class="modal1">
                                                                                          ...
                                                                                          <div class="d-flex justify-content-end gap-2 mt-3">
                                                                                               <div class="button_noti button_noti_pri d-none">
                                                                                                    <button type="button" class="btn btn-secondary">Ver Más.</button>
                                                                                               </div>
                                                                                               <div class="button_noti button_noti_sec d-none">
                                                                                                    <button type="button" class="btn btn-secondary">Ver Más.</button>
                                                                                               </div>
                                                                                          </div>
                                                                                     </div>
                                                            ...
                                                            <div class="row border rounded p-3 m-3 mb-3">
                                                                 <div class="col-lg-12">
                                                                      <div class="mb-3">
                                                                           ...
                                                                           <input class="form-control" type="text" placeholder="" id="titleCampaing" name="titleCampaing" required maxlength="100">
                                                                           
                                                                      </div>
                                                                 </div>
                                                                 <div class="col-lg-12">
                                                                      <div class="mb-3">
                                                                           <label class="form-label" for="subTitleCampaing">Descripcion de la campaña</label>
                                                                      ...
                                                                      <div class="row p-3">
                                                                           ...
                                                                           <div class="col-12 ps-0">
                                                                                <small class="text-muted">
                                                                                     La notificación se enviará una sola vez en la fecha y hora seleccionadas.
                                                                                </small>
                                                                           </div>
                                                                 ...
                                                                 <div class="col-12 d-none" id="schedule-daily">
                                                                      <div class="row p-3">
                                                                           ...
                                                                           <div class="col-md-4">
                                                                                ...
                                                                                type="date"
                                                                                class="form-control"
                                                                                id="schedule_daily_start"
                                                                                name="schedule_daily_start"
                                                                                >
                                                                           </div>
                                                                           ...
                                                                           <div class="col-md-4">
                                                                                ...
                                                                                type="date"
                                                                                class="form-control"
                                                                                id="schedule_daily_end"
                                                                                name="schedule_daily_end"
                                                                                >
                                                                           </div>

                                                                           <div class="col-12">
                                                                                <small class="text-muted d-block mt-2">
                                                                                Se enviará todos los días a la hora indicada dentro del rango de fechas.
                                                                                </small>
                                                                           </div>
                                                                 ...
                                                                 <div class="col-12 d-none" id="schedule-custom">
                                                                      ...
                                                                      <div class="col-12 d-none" id="custom-every-n-days">
                                                                           ...
                                                                           <input type="number" min="1" class="form-control"
                                                                                     id="custom_every_n" name="custom_every_n">
                                                                           </div>

                                                                           <div class="col-md-4">
                                                                           <label class="form-label" for="custom_time_n">Hora</label>
                                                                           <input type="time" class="form-control"
                                                                                     id="custom_time_n" name="custom_time_n">
                                                                           </div>

                                                                           <div class="col-md-4">
                                                                           <label class="form-label" for="custom_start_n">Fecha inicio</label>
                                                                           <input type="date" class="form-control"
                                                                                     id="custom_start_n" name="custom_start_n">
                                                                           </div>

                                                                           <div class="col-12 mt-2">
                                                                           <small class="text-muted">
                                                                                Se enviará cada <b>N</b> días, desde la fecha inicio, a la hora indicada.
                                                                           </small>
                                                                           </div>
                                                                           </div>
                                                                      </div>
                                                                      ...
                                                                      <div class="col-12 d-none" id="custom-weekly">
                                                                           ...
                                                                           <input type="time" class="form-control"
                                                                                     id="custom_week_time" name="custom_week_time">
                                                                           </div>

                                                                           <div class="col-md-4">
                                                                           <label class="form-label" for="custom_week_start">Fecha inicio</label>
                                                                           <input type="date" class="form-control"
                                                                                     id="custom_week_start" name="custom_week_start">
                                                                           </div>

                                                                           <div class="col-md-4">
                                                                           <label class="form-label" for="custom_week_end">Fecha fin (opcional)</label>
                                                                           <input type="date" class="form-control"
                                                                                     id="custom_week_end" name="custom_week_end">
                                                                           </div>

                                                                           <div class="col-12 mt-2">
                                                                           <small class="text-muted">
                                                                                Se enviará en los días seleccionados a la hora indicada (hasta la fecha fin si la defines).
                                                                           </small>
                                                                           </div>
                                                                           </div>
                                                                      </div>
                                                                      ...
                                                                      <div class="col-12 d-none" id="custom-monthly">
                                                                           ...
                                                                           <input type="number" min="1" max="31" class="form-control"
                                                                                     id="custom_month_day" name="custom_month_day">
                                                                           </div>

                                                                           <div class="col-md-4">
                                                                           <label class="form-label" for="custom_month_time">Hora</label>
                                                                           <input type="time" class="form-control"
                                                                                     id="custom_month_time" name="custom_month_time">
                                                                           </div>

                                                                           <div class="col-md-4">
                                                                           <label class="form-label" for="custom_month_start">Fecha inicio</label>
                                                                           <input type="date" class="form-control"
                                                                                     id="custom_month_start" name="custom_month_start">
                                                                           </div>

                                                                           <div class="col-12 mt-2">
                                                                           <small class="text-muted">
                                                                                Se enviará cada mes el día indicado a la hora indicada, desde la fecha inicio.
                                                                           </small>
                                                                           </div>
                                                                           </div>
                                                                      </div>
...
<script>
     ...
     var postDispositivosSendNew2="{{$overview['postDispositivosSendNew2']}}";
     var postDispoTemplateSendNew="{{$overview['postDispoTemplateSendNew']}}";
     var postDispoTemplateNumSendNew="{{$overview['postDispoTemplateNumSendNew']}}";
</script>
...
<script src="{{ URL::asset('assets/js/pages/form-advanced2.init.js') }}"></script>
