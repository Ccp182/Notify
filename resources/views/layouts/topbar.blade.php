    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index.html" class="logo ">
                   <img src="{{ $overview['LOGO_WHITE'] }}" alt="logo-dark" height="40">
                  
                </a>

            </div>

            <!--<button type="button" class="btn btn-sm px-3 font-size-24 header-item waves-effect" id="vertical-menu-btn"  title="Mostrar/Ocultar Menú">
        ...
        <div class="d-flex">
            ...
            <button class="btn header-item"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="" src="https://flagsapi.com/{{ $Pais ?? '' }}/flat/32.png" alt="Header Language" height="32">
            </button>
            ...
            <div class="dropdown d-none d-lg-inline-block ms-1">
                <button type="button" class="btn header-item noti-icon waves-effect" data-toggle="fullscreen" title="Pantalla Completa">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{asset('assets/images/users/avata.png')}}"
                        alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1">{{ $FName }}</span>
